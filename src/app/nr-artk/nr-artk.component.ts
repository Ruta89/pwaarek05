...
export class State {
  constructor(public color: string, public artykul: string, public tonaz: number, public rodzaj: string) { }
}
...
export class NrArtkComponent {
  state = '';
  onEnter(state: string) { this.state = state; }
  ...
  states: State[] = [
    ...
    {
      'color': 'https://www.rhtltd.co.uk/image/cache/catalog/Miller%20Weblift/Images/Round%20Slings/2-tonne-round-sling-(1)-500x500.jpg',
      'artykul': '5141512',
      'tonaz': 2000,
      'rodzaj': 'DeForce 1'
    },
    ...
    {
      'color': 'https://www.bishopliftingequipment.co.uk/wp-content/uploads/2016/03/5-ton-round-850x850.jpg',
      'artykul': '5145512',
      'tonaz': 5000,
      'rodzaj': 'DeForce 1'
    },
  ...
  filterStates(artykul: string) {
    return this.states.filter(state =>
      state.artykul.indexOf(artykul) === 0);
  }
