...
`);
  ...
  function pakowanie(agent) {
    ...
    if (tonaz === 2) {
      ...
      if (dlugosc === 1.5) {
        agent.add(`${tonaz} tony ${dlugosc} metry banderola dwa razy, pakuj po 10 sztuk  i wiązkę 2 razy  spinaj.`);
      }
      if (dlugosc === 2) {
        agent.add(`${tonaz} tony ${dlugosc} metry banderola dwa razy, pakuj po 5 sztuk i wiązkę raz spinaj.`);
      }
      if (dlugosc === 2.5) {
        agent.add(`${tonaz} tony ${dlugosc} metry spiąć taśmą raz, pakuj po 5 sztuk i wiązkę zepnij raz taśmą. `);
      }
      if (dlugosc === 3) {
        agent.add(`${tonaz} tony ${dlugosc} metry spiąć  taśmą dwa razy, pakuj po 5 sztuk i wiązkę zepnij raz taśmą. `);
      }
      if (dlugosc === 4) {
        agent.add(` ${tonaz} tony ${dlugosc} metry spiąć taśmą dwa razy, pakuj po 5 sztuk i wiązkę zepnij raz taśmą.  `);
      }
      if (dlugosc > 5) {
        agent.add(` ${tonaz} tony ${dlugosc} metry spiąć taśmą dwa razy pakować osobno.`);
      }
    } // 2 tony
    if (tonaz === 3) {
      if (dlugosc <= 1) {
      ...
      if (dlugosc === 1.5) {
        agent.add(` ${tonaz} tony ${dlugosc} metry  banderola dwa razy, pakuj po 5 sztuk i wiązkę dwa razy taśmą spinaj.`);
      }
      if (dlugosc === 2) {
        agent.add(` ${tonaz} tony ${dlugosc} metry  banderola dwa razy, pakuj po 5 sztuk i raz spinaj.`);
      }
      if (dlugosc === 2.5) {
        agent.add(` ${tonaz} tony ${dlugosc} metry spiąć raz taśmą, pakuj po 5 sztuk, wiązkę raz spinaj.`);
      }
      if (dlugosc === 3) {
    ...
    if (tonaz === 4) {
      if (dlugosc < 2.5) {
        agent.add(` ${tonaz} tony ${dlugosc} metr  spiąć   raz, pakować po 5 sztuk wiązkę też spiąć raz`);
